...
// food editor
    ...
    ,'Add food from your database' : {
      ...
      ,de: 'Ergänze Nahrung durch deine Datenbank'
    ...
    ,'Your device is not authenticated yet' : {
      ...
      ,de: 'Dein Gerät ist derzeit noch nicht authentifiziert'
    ...
    ,'Insulin-on-Board' : {
      cs: 'IOB'
      ,de: 'aktives schnell wirksames Bolus-Insulin'
    ...
    ,'Carbs-on-Board' : {
      cs: 'COB' 
      ,de: 'aktive wirksame Kohlenhydrate'
    ...
    ,'Bolus Wizard Preview' : {
      ...
      ,de: 'Bolus Insulin Vorschau Assistent'
    ...
    ,'Cannula Age' : {
      ...
      ,de: 'Insulinpumpen Katheter Setzzeit'
      ,it: 'CAGE-Cambio Ago'
      ,nb: 'Nålalder'
    ...
    ,'This task find and remove treatments in the future.' : {
      ...
      ,nb: 'Finn og fjern fremtidige behandlinger'
      ,de: 'Diese Aufgabe findet und entfernt Behandlungen in der Zukunft.'
    ...
    ,'Find and remove entries in the future' : {
      ...
      ,pl: 'Znajdź i usuń wpisy w przyszłości'
    ...
    ,'This task find and remove CGM data in the future created by uploader with wrong date/time.' : {
      ...
      ,de: 'Diese Aufgabe findet und entfernt CGM Daten in der Zukunft, die vom Uploader mit falschem Datum/Uhrzeit erstellt wurden. '
    ...
    ,'Database contains %1 future records' : {
      ...
      ,de: 'Datenbank enthält %1 zukünftige Aufnahmen'
    ...
    ,'Remove %1 selected records?' : {
      ...
      ,de: 'Ausgewählte %1 Aufnahmen löschen?'
    ...
    ,'Error removing record %1' : {
      ...
      ,de: 'Fehler beim Entfernen der Aufnahme %1'
    ...
    ,'Clean Mongo status database' : {
      ...
      ,de: 'Säubere Mongo Status Datenbank'
    ...
    ,'Delete all documents from devicestatus collection' : {
      ...
      ,de: 'Lösche alle Dokumente von Einheitsstatussammlung'
    ...
    ,'This task removes all documents from devicestatus collection. Useful when uploader battery status is not properly updated.' : {
      ...
      ,de: 'Diese Aufgabe entfernt alle Dokumente von Einheitstatussammlung. Nützlich wenn Uploader-Batteriestatus nicht richtig aktualisiert.'
    ...
    ,de: 'Entferne alle Dokumente vom Einheitstatussammlung Einheitsstatus?'
    ...
    ,'Database contains %1 records' : {
      ...
      ,de: 'Datenbank enthält %1 Aufnahmen'
    ...
    ,'Save current record before changing to new?' : {
      ...
      ,de: 'Aktuelle Aufnahmen vor dem Wechsel zu einer Neuen speichern?'
    ...
    ,'Represents the typical duration over which insulin takes effect.  Varies per patient and per insulin type. Typically 3-4 hours for most pumped insulin and most patients. Sometimes also called insulin lifetime.' : {
      ...
      ,de: 'Entspricht der typischen Dauer die das Insulin wirkt. Variiert je Patient und Insulintyp. Häufig 3-4 Stunden für das häufig abgegebene Insulin und die meisten Patienten. Manchmal auch Insulin-Wirkungsdauer genannt.'
      ...
      ,pl: 'Odzwierciedla czas dzialania insuliny. Może różnić sie w zależnosci od chorego i rodzaju insuliny. Zwykle sa to 3-4 godziny dla insuliny podawanej pompą u wiekszości chorych. Inna nazwa to czas trwania insuliny.'
    ...
    ,'Insulin to carb ratio (I:C)' : {
      ...
      ,nb: 'IKH forhold'
      ,de: 'Insulin/Kohlenhydrathe-Verhältnis (I:C)'
    ...
    ,'g carbs per U insulin. The ratio of how many grams of carbohydrates are offset by each U of insulin.' : {
      ...
      ,de: 'g Kohlenhydrathe pro Einheit Insulin. Das Verhältnis wie viele Gramm Kohlenhydrathe je Einheit Insulin verbraucht werden. '
    ...
    ,'mg/dL or mmol/L per U insulin. The ratio of how much BG changes with each U of corrective insulin.' : {
      ...
      ,de: 'mg/dL oder mmol/L Insulineinheit. Verhältnis von Blutzuckeränderung je Einheit zum Korrekturinsulin.'
    ...
    ,'Carbs activity / absorption rate' : {
      ...
      ,de: 'Kohlenhydrathaktivität / Aufnahme Kohlenhydrathe'
      ,sv: 'Kolhydratstid'
      ,nb: 'Karbohydrattid'
    ...
    ,'grams per unit time. Represents both the change in COB per unit of time, as well as the amount of carbs that should take effect over that time.  Carb absorption / activity curves are less well understood than insulin activity, but can be approximated using an initial delay followed by a constant rate of absorption (g/hr).' : {
      ...
      ,de: 'Gramm pro Einheitenzeit. Bedeutet sowohl die Änderung in COB je Einheitenzeit, als auch die Menge an Kohlenhydrathen die über diese Zeit wirken. Kohlenhydrathe-Abgabe / Aktivitätskurven werden weniger beachtet als Insulinaktivität, aber es kann bei einer Anfangsverzögerung mit konstanter Aufnahme genutzt werden (g/std).'
    ...
    ,'Start of record validity' : {
      ...
      ,de: 'Starte Aufzeichnungsgültigkeit'
    ...
    ,'Calculation is in target range.' : {
      ...
      ,de: 'Kalkulation ist innerhalb Zielbereich'
    ...
    ,'Default values used.' : {
      ...
      ,de: 'Standartwerte werden verwendet.'
    ...
    ,'Error. Default values used.' : {
      ...
      ,de: 'Fehler. Standartwerte werden verwendet.'
    ...
    ,'Time ranges of target_low and target_high don\'t  match. Values are restored to defaults.' : {
      ...
      ,de: 'Zeitspanne vom untersten und obersten Wert werden nicht berücksichtigt. Werte auf Standart hergestellt.'
      ,ro: 'Intervalele temporale pentru țintă_inferioară și țintă_superioară nu se potrivesc. Se folosesc valorile implicite.'
      ,sv: 'Tidsintervall för målområde låg och hög stämmer ej. Återgår till standardvärden'
    ...
    ,'Save current record before switching to new?' : {
      ...
      ,de: ' Aktuelle Aufzeichnung vor dem Wechsel speichern?'
    ...
    ,'Add new interval before' : {
      ...
      ,de: 'Neuen Intervall vorher hinzufügen'
    ...
    ,'When enabled icon to start edit mode is visible' : {
      ...
      ,de: 'Mit Aktivieren des Icons ist der Bearbeitungsmodus sichtbar'
      ...
      ,sv: 'När aktiverad, ikonen för editering är synlig'
      }
    ,'Operation' : {
      cs: 'Operace'
      ,ro: 'Operațiune'
    ...
    ,'Change treatment time to %1 ?' : {
      ...
      ,de: 'Behandlungsdauer ändern zu %1 ?'
    ...
    ,'Change carbs time to %1 ?' : {
      ...
      ,de: 'Kohlenhydrath-Zeit ändern zu %1 ?'
    ...
    ,'Remove insulin from treatment ?' : {
      ...
      ,de: 'Insulin von Behandlung löschen?'
    ...
    ,'Remove carbs from treatment ?' : {
      ...
      ,de: 'Kohlenhydrathe von Behandlung löschen?'
    ...
    ,'Profile is going to be saved in newer format used in Nightscout 0.9.0 and above and will not be usable in older versions anymore.\nAre you sure?' : {
      ...
      ,de: 'Profil wird in einem neuem Format für Nightscout 0.9.0 und höher gespeichert und ist nicht mehr nutzbar in älteren Versionen. Sind Sie sicher?'
      ,sv: 'Profilen kommer att sparas i ett nyare format för Nightscout 0.9.0 eller högre, och är inte bakåtkompatibel till äldre versioner.\nÄr du säker?'
    ...
    ,'Wrong profile setting.\nNo profile defined to displayed time.\nRedirecting to profile editor to create new profile.' : {
      ...
      ,sv: 'Fel i profil inställningen.\nIngen profil är definerad för att visa tid.\nOmdirigerar till profilediteraren för att skapa en ny profil.'
