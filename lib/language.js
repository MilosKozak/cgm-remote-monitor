...
// food editor
    ...
    ,'When enabled an alarm may sound.' : {   
      ...
      ,bg: 'Когато е ключено, алармата ще има звук'
      }
    ,'Urgent High Alarm' : {   
      ...
      ,bg: 'Внимание аларма за ВИСОКА КЗ'
      }
    ,'High Alarm' : {   
      cs: 'Vysoká glykémie'
      ,de: 'Hoch Alarm'
    ...
    ,'Urgent Low Alarm' : {   
      ...
      ,bg: 'Внимание. Аларма за НИСКА КЗ'
      }
    ,'Stale Data: Warn' : {   
      cs: 'Zastaralá data'
    ...
    ,'Alarm Test / Smartphone Enable' : {   
      ...
      ,bg: 'Тестване на алармата / Активиране за мобилни телефони'
      }
    ,'Bolus Wizard' : {   
    ...
    ,'Carb Time' : {   
      ...
      ,bg: 'Време за усвояване на възглехидратите'
      }
