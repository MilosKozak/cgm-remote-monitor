...
function init (client, d3) {
  ...
  function boluscalcTooltip (treatment) {
    ...
    var html = '<hr>';
    html += (treatment.boluscalc.othercorrection ? '<strong>'+translate('Other correction')+':</strong> ' + parseFloat(treatment.boluscalc.othercorrection).toFixed(2) + '<br/>' : '');
    if (treatment.boluscalc.foods.length) {
