...
function configure (app, wares) {
  ...
  api.get('/status', function (req, res) {
      var info = { status: 'ok'
          ...
          , careportalEnabled: app.enabled('api') && ( app.enabled('careportal') || app.enabled('boluscalc') ) // boluscalc implies careportal
          , boluscalcEnabled: app.enabled('api') && app.enabled('boluscalc')
